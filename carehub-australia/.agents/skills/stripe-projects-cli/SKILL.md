...
This repository is initialized for the Stripe project "carehub-australia".
...
| `TOS_ACCEPTANCE_REQUIRED` | Developer or provider terms not accepted | Re-run with `--accept-tos --yes` |
