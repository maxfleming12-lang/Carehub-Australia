...
The client is a 32-year-old male living with Autism Spectrum Disorder (Level 2). He currently resides in a supported independent living arrangement with two other participants.
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
                ...
                <CardContent className="p-5">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <Input placeholder="e.g. John Smith" value={context.clientName} onChange={(e) => setContext({ ...context, clientName: e.target.value })} className="text-sm" />
                    </div>
                    <div>
              ...
              <Button variant="primary" size="lg" className="w-full" onClick={handleGenerate} disabled={generating}>
                {generating ? (<><RefreshCw className="h-4 w-4 animate-spin" />Generating...</>) : isLocked ? (<><Lock className="h-4 w-4" />Sign Up to Generate</>) : (<><Zap className="h-4 w-4" />Generate Document</>)}
              </Button>
            </div>
                ...
                <CardContent className="p-5">
                  ...
                  {generated && (
                    <div className="relative">
                      ...
                      <pre className="whitespace-pre-wrap text-xs font-mono text-gray-700 bg-gray-50 rounded-xl p-4 border border-gray-200 max-h-[600px] overflow-y-auto leading-relaxed">{sampleOutput}</pre>
                    </div>
                  )}
                </CardContent>
              </Card>
